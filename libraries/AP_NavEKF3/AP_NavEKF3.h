...
private:
    ...
    AP_Float _mag_str_limit;        // frequency of output observer height rate complementary filter in Hz
    AP_Float _mag_dir_limit_deg;    // frequency of output observer height rate complementary filter in Hz
